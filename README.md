Device configuration for Unihertz Atom XL (Atom_XL) TEE (non-european union)
=================================================
...
![](https://github.com/ADeadTrousers/android_device_Unihertz_Atom_XL/blob/lineage-20.0/docs/images/atom_xl.png)
